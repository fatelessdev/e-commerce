        ...
        >
          <div className="flex justify-between items-center px-6 md:px-12 lg:px-16 h-20">
            ...
            <div className="flex-1 flex justify-end">
              <button onClick={() => setShowSearch(false)} aria-label="Close search" className="p-2 -mr-2 text-foreground/80 hover:text-foreground transition-colors">
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-6 pb-32">
            <form onSubmit={handleSearchSubmit} className="w-full max-w-3xl relative">
              ...
              />
              <button type="submit" aria-label="Submit search" className="absolute right-0 bottom-6 text-foreground hover:text-red-accent transition-colors">
