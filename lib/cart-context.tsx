...
export function CartProvider({ children }: { children: ReactNode }) {
    ...
    // Performance optimization: Memoize O(N) array reductions to prevent recalculating
  // total cart items and price on every render cycle when cart contents havent changed.
