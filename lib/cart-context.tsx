...
export function CartProvider({ children }: { children: ReactNode }) {
    ...
    // Performance optimization: Memoize context value and derived computations to prevent re-renders in consumers
    const contextValue = useMemo(() => ({
        ...
        isOpen,
        setIsOpen,
    }), [items, isHydrated, isOpen, totalItems, totalPrice, addItem, addCombo, removeItem, updateQuantity, clearCart])
